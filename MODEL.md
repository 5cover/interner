...
| ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Object | Exact `Object.prototype`; ordered own string and symbol keys; every complete own data or accessor descriptor, including its kind, flags and data value or getter/setter references                                                                        |
