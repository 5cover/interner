...
| --------------------- | --------------: | ---------------: | ---------: | ----------: |
| zod-json-schema       |          -94.3% |           -77.2% |     -94.3% |     14.2 ms |
| openapi-document      |          -95.9% |           -62.6% |     -94.9% |     17.8 ms |
| typescript-source-ast |          -44.7% |           -55.8% |     -28.2% |     11.4 ms |
| configuration-tree    |          -94.5% |           -48.1% |     -88.6% |     6.71 ms |
